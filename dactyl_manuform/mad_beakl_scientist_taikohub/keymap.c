...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_5x6(
        LGUI(KC_F), WRITE_VIM, KC_LCBR, KC_LPRN, KC_LBRACKET, QUIT_VIM,                _______, KC_RBRACKET, KC_RPRN, KC_RCBR, KC_COLON, KC_DELETE,
        ...
        KC_LCTRL, LT(2,KC_QUOTE), LT(2,KC_COMMA), KC_J, KC_K, KC_X,                    KC_V, KC_M, KC_L, KC_F, LT(4,KC_SLASH), RCTL_T(KC_SCOLON),
                  KC_LGUI, KC_LALT,                                                                           KC_LEFT, KC_RIGHT,
                                             LT(1,KC_ESCAPE), LT(3,KC_DOT),               KC_SPACE, LT(4,KC_ENTER),
                                                     KC_LGUI, KC_LALT,                           KC_END,  KC_DEL,
                                                     KC_HOME, KC_GRV,                          KC_LGUI, KC_LALT
    ),
    ...
    [SYMBOLS] = LAYOUT_5x6(
      ...
      _______, KC_TILD, KC_AT, KC_PERC, KC_EXLM, KC_GRAVE,                             KC_AMPR, KC_7, KC_8, KC_9, KC_BSLASH, KC_PIPE,
    ...
    [FUNCTIONS] = LAYOUT_5x6(
      _______, LSFT(KC_F4), LSFT(KC_F5), LSFT(KC_F6), LSFT(KC_F7), LSFT(KC_F8),     _______, _______, _______, _______, _______, _______,
      _______, KC_F12, KC_F7, KC_F8, KC_F9, LSFT(KC_F3),                                 _______, KC_HOME, KC_UP, KC_END, _______, LCTL(KC_F10),
      _______, KC_F11, KC_F4, KC_F5, KC_F6, LSFT(KC_F2),                                 _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
      _______, KC_F10, KC_F1, KC_F2, KC_F3, LSFT(KC_F1),                                 _______, LCTL(KC_LEFT), KC_CAPSLOCK, RCTL(KC_RIGHT), _______, _______,
                                      _______, _______,                                                _______, _______,                                                
                                                 _______, _______,                       _______, _______,
                                                     _______,_______,                _______,  _______,
                                                     _______, _______,               _______, _______
